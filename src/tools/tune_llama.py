...
def train(p: _Params):
    tokenizer: LLaMATokenizer = LLaMATokenizer.from_pretrained(Path("/media/anne/the_one/llama/models/conv/llama-7b/tokenizer.model"), use_fast=False)  # type: ignore
    model: LLaMAForCausalLM = LLaMAForCausalLM.from_pretrained(Path("/media/anne/the_one/llama/models/conv/llama-7b/"))  # type: ignore
